...
The SourceExtractor pipeline, shown in Figure~\ref{fig:sourceextractor}, processes images from the 
astronomical telescopes and produces astroid catalogs. 
The object catalog include the position, shape, and other statistical properties of the object.
...
One use case is for astronomers to find out the bright objects over a threshold and validate that these objects are indeed astroids rather
