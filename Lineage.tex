...
(Figure~\ref{fig:conceptual} shows an conceptual example), we are able to identify seven primitive lineage types.
...
filter out the data items that are derived from the images that have people and dogs togetehr , and apply the filtered dataset directly to the linear solver.
...
\label{sec:Req}
The requirements of the SystemL lineage system for KeystoneML can be viewed from the functionality and performance perspective.

\subsection{Functional Requirements}
SystemL should expose a programming interface for users to declare and operate the lineage of each transformer. 
SystemL's built-in lineage should cover the most common lineage types and preserve the flexibility for users to declare their own lineage types.
SystemL also requires an interactive interface for users to load recorded lineage and query over it.
