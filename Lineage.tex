...
An analysis on the 8 machine measurement shows that the Extractor contributes 87.6\% of the cost when SystemX only captures metadata mapping.
...
For both pipelines, geometry lineage dominates the wall clock time overhead of metadata mapping capturing since the mapping is arbitrary and large in size.
