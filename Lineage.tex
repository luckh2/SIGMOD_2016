...
If the data lineage of an element $e, e \in I_{i+1}$ with respect to transformer $T_i$ is a group of elements $(e_1, ..., e_m)$ in $I_i$, 
then it suffices the following property:
$ \overline{I_{i+1}(e)} = $
