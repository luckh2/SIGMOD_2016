...
Figure~\ref{fig:vocsiftfisher} shows the VOCSIFTFisher pipeline. The pipeline uses Principal Component Analysis (PCA) and a gaussian Mixture Model (GMM) to build visual vocabularies for image classification.
\begin{figure}[h]
\begin{center}
