...
ax1.set_xticklabels(xlabels, size='large')
ax1.set_yticklabels(ylabels, size='large')
ax1.legend((line1[0], line2[0], line3[0], line4[0]), ('VOC NoLineage', 'VOC Meta', 'VOC Meta+Data', 'Ideal'), loc='best')
ax1.grid(True)
ax1.set_title('VOCSIFTFisher')
ax1.set_ylabel('Speedup over 8 nodes (x)', size='large')
...
ax2.set_xticklabels(xlabels, size='large')
ax2.set_yticklabels(ylabels, size='large')
ax2.legend((line5[0], line6[0], line7[0], line8[0]), ('SE NoLineage', 'SE Meta', 'SE Meta+Data', 'Ideal'), loc='best')
ax2.grid(True)
ax2.set_title('Source Extractor')
ax2.set_xlabel("Number of nodes", size='large')
...
ax3.set_xticklabels(xlabels, size='large')
ax3.set_yticklabels(ylabels, size='large')
ax3.legend((line9[0], line10[0], line11[0], line12[0]), ('MNIST NoLineage', 'MNIST Meta', 'MNIST Meta+Data', 'Ideal'), loc='best')
ax3.grid(True)
ax3.set_title('MNIST')
